...
import {
  MATRICULA_CREATE_FAIL,
  MATRICULA_CREATE_REQUEST,
  MATRICULA_CREATE_SUCCESS,
  MATRICULA_DELETE_FAIL,
  MATRICULA_DELETE_REQUEST,
  MATRICULA_DELETE_SUCCESS,
  MATRICULA_FIND_FAIL,
  MATRICULA_FIND_REQUEST,
  MATRICULA_FIND_RESET,
  MATRICULA_FIND_SUCCESS,
