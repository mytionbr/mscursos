...
export const createPost =
  ({ titulo, conteudo, curso, categoria }) =>
...
export const saveResposta =
  (resposta, postId) => async (dispatch, getState) => {
...
export const markResponseAsSolution =
  ({ resposta_id, post_id, aluno_id }) =>
  async (dispatch, getState) => {
