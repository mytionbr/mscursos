...
export const cursoProfessorReducer = (state = { loading: true }, action) => {
  switch (action.type) {
...
export const cursoDetailsReducer = (state = { loading: true }, action) => {
  switch (action.type) {
...
export const cursoInformaionsReducer = (state = { loading: true }, action) => {
  switch (action.type) {
...
export const cursoUpdateReducer = (state = {}, action) => {
  switch (action.type) {
...
export const cursoMatriculaReducer = (state = { loading: true }, action) => {
  switch (action.type) {
...
export const cursoFindAvaliacaoReducer = (
  state = { loading: true },
  action
) => {
  switch (action.type) {
    case CURSO_AVALIACAO_DETAILS_REQUEST:
      return { loading: true, empty: false };
    case CURSO_AVALIACAO_DETAILS_SUCCESS:
      return { loading: false, data: action.payload, empty: false };
...
export const cursoSaveAvaliacaoReducer = (state = {}, action) => {
  switch (action.type) {
    case CURSO_AVALIACAO_SAVE_REQUEST:
      return { loading: true };
    case CURSO_AVALIACAO_SAVE_SUCCESS:
      return { loading: false, success: true };
